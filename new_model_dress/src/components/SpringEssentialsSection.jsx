...
import { SPRING_ESSENTIALS_PRODUCTS } from '../data/flatlayProducts';
import { ChevronLeft, ChevronRight, Eye } from 'lucide-react';

export default function SpringEssentialsSection({ onOpenQuickView, onSelectCollection }) {
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-10">
        ...
        <div className="text-center max-w-2xl mx-auto mb-14 space-y-3.5">
          ...
          <p className="text-xs sm:text-[14px] text-neutral-600 dark:text-neutral-400 font-light leading-relaxed">
            A new season calls for a new perspective. This edit brings together fluid silhouettes, bold choices, and refined textures — styled for the days ahead. Quiet confidence, season after season.
          </p>
          <div className="pt-1">
            <button
              onClick={() => onSelectCollection('Court & Country')}
            ...
            >
              <span>•</span>
              <span className="underline underline-offset-4">Discover the Essentials</span>
            </button>
          </div>
        </div>
        ...
        <div className="relative group">
          ...
          >
            {SPRING_ESSENTIALS_PRODUCTS.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="relative aspect-square w-full bg-[#f6f6f4] dark:bg-[#1a1d1b] rounded-sm overflow-hidden flex items-center justify-center p-8 transition-colors duration-300">
                    ...
                    {/* Sale Badge */}
                    {item.isSale && (
                      <div className="absolute top-4 right-4 text-[11px] uppercase tracking-wider text-neutral-600 dark:text-neutral-400 font-medium">
                        Sale
                      </div>
                    )}
                  ...
                  {/* Card Bottom: Title, Price, and Color Swatches */}
